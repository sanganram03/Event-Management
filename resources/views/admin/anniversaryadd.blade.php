...
<div class="card ">
  ...
  <div class="table-responsive">
    <form action="{{url('api/addanniversary')}}" method="POST" enctype="multipart/form-data">
              ...
              <tr>
                <td class="">
                  <div class="">
                    ...
                    <select name="anniversary" required autocomplete="off">
                ...
                <tr>
                    <td>
                        <div class="">
                          <p class="text-xs font-weight-bold mb-0">Date of Event</p>
                          <input type="date" name="dateofanni" required>
                        </div>
                      </td>
                    </tr>
              <tr>
