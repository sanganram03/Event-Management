        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">List Anniversary</h6>
              </nav>
      ...
      <div class="table-responsive">
        <table class="table align-items-center ">
          <tbody>
            ...
            @foreach ($annivers as $annivers)
            <tr>
              <td>
                <div class="d-flex px-2 py-1 align-items-center">

                  <div class="ms-4">
                    <h6 class="text-sm mb-0">{{$annivers->id}}</h6>
                  </div>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$annivers->name}}</h6>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$annivers->anniversary}}</h6>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$annivers->start}}</h6>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$annivers->end}}</h6>
                </div>
              </td>
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                  <h6 class="text-sm mb-0">{{$annivers->phone}}</h6>
                </div>
              </td>
              ...
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                  <h6 class="text-sm mb-0">{{$annivers->address}}</h6>
                </div>
              </td>
                ...
                <div class="col text-center">
                    <ul class="list-inline m-0">
                        <li class="list-inline-item">
                            <a href="{{url('api/annidetails',$annivers->id)}}" class="btn btn-success"  onclick="return confirm('are you sure to View this annivers?')">View</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{url('api/editanni',$annivers->id)}}" class="btn btn-primary"  onclick="return confirm('are you sure to Edit this annivers?')">Edit</a>
                        </li>

                        <li class="list-inline-item">
                            <a href="{{url('api/deleteanni',$annivers->id)}}" class="btn btn-danger"  onclick="return confirm('are you sure to Delete this annivers?')">Delete</a>
                        </li>
                    </ul>
                </div>
              </td>
