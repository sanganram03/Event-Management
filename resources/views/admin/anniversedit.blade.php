        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">Edit Anniversary Details</h6>
              </nav>
...
<div class="card ">
  ...
  <div class="table-responsive">
    ...
    <form action="{{url('api/anniedit',$annivers->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <tr>
            <td>
                <div class="">
                  ...
                  <input type="text" name="name" value="{{$annivers->name}}" required>
                </div>
              </td></tr>
              <tr>
                <td class="">
                  <div class="">
                    ...
                    <input type="text" name="anniversary" value="{{$annivers->anniversary}}" required>
                  </div>
                </td>
                </tr>
                <tr>
                    <td>
                        <div class="">
                          ...
                          <input type="datetime-local" name="start" value="{{$annivers->start}}" required>
                        </div>
                      </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="">
                              ...
                              <input type="datetime-local" name="end" value="{{$annivers->end}}"  required>
                            </div>
                          </td>
                        </tr>
              <tr>
                <td class="align-middle text-sm">
                  <div class="">
                    ...
                    <input type="number" name="phone" value="{{$annivers->phone}}"  required>
                  </div>
                </td></tr>
                <tr>
              <td>
                <div class="">
                  ...
                  <input type="email" name="email" value="{{$annivers->email}}"  required>
                </div>
              </td></tr>
              <tr>
                <td>
                  <div class="">
                    ...
                    <input type="text" name="address" value="{{$annivers->address}}"  required>
                  </div>
                </td></tr>
       <tr>
            <td class="">
