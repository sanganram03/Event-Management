        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">Event Detail</h6>
              </nav>
...
<div class="card ">
  ...
  <div class="table-responsive">
    <form action="{{url("api/eventslist")}}" method="POST" enctype="multipart/form-data">
        ...
        <tr>
            <td>
                <div class="">
                  ...
                  <input type="text" name="title" value="{{$events->title}}" readonly>
                </div>
              </td></tr>
              <tr>
              <td>
                <div class="">
                  ...
                  <input type="text" name="description" value="{{$events->description}}" style="height:200px"readonly>
              ...
              <td class="align-middle text-sm">
                <div class="">
                  ...
                  <input type="datetime-local" name="start" value="{{$events->start}}" readonly>
                </div>
              </td></tr>
              <td class="align-middle text-sm">
                <div class="">
                  <p class="text-xs font-weight-bold mb-0">End time</p>
                  <input type="datetime-local" name="end" value="{{$events->end}}" readonly>
                </div>
              </td></tr>
              <tr>
              <td class="">
                <div class="">
                  ...
                  <input type="text" name="venue" value="{{$events->venue}}" readonly>
                </div>
              </td>
        </tr>
        <tr>
            <td class="">
              <div class="">
                <input type="submit" name="Back" readonly>
              </div>
            </td>
      </tr></tbody>
