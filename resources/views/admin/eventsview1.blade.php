        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">List Events</h6>
              </nav>
    ...
    <div class="card ">
      ...
      <div class="table-responsive">
        <table class="table align-items-center ">
          <tbody>
            <a href="{{ url('api/eventsadd') }}" class="btn btn-success">Add New</a>
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1 align-items-center">
                  ...
                  <div class="ms-4">
                    <h6 class="text-sm mb-0">{{$events->id}}</h6>
                  </div>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$events->title}}</h6>
                </div>
              </td>
              <td class="w-30">
                <div class="text-center">
                  <h6 class="text-sm mb-0">{{$events->description}}</h6>
                </div>
              </td>
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                  <h6 class="text-sm mb-0">{{$events->start}}</h6>
                </div>
              </td>
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                  <h6 class="text-sm mb-0">{{$events->venue}}</h6>
                </div>
              </td>
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                    <ul class="list-inline m-0">
                        <li class="list-inline-item">
                            <a href="{{url('api/eventdetails',$events->id)}}" class="btn btn-success"  onclick="return confirm('are you sure to View this event?')">View</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{url('api/eventedit',$events->id)}}" class="btn btn-primary"  onclick="return confirm('are you sure to Edit this event?')">Edit</a>
                        </li>

                        <li class="list-inline-item">
                            <a href="{{url('api/deleteeven',$events->id)}}" class="btn btn-danger"  onclick="return confirm('are you sure to Delete this event?')">Delete</a>
                        </li>
                    </ul>
                </div>
              </td>
