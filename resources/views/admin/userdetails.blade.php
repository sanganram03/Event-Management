        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">View User Details</h6>
              </nav>
...
<div class="card ">
  ...
  <div class="table-responsive">
    <form action="{{url('api/userslist')}}" method="POST" enctype="multipart/form-data">
            ...
            <td>
              ...
              <td class="align-middle text-sm">
                <div class="">
                  ...
                  <input type="number" name="phone" minlength ="10" maxlength ="10" value="{{$user->phone}}" readonly>
                </div>
              </td></tr>
              <tr>
                <td class="">
                  <div class="">
                    ...
                    <select name="gender" readonly autocomplete="off">
              ...
              <td class="">
                <div class="">
                  ...
                  <select name="usertype" readonly autocomplete="off">
