                ...
                <div class="col text-center">
                    <ul class="list-inline m-0">
                        <li class="list-inline-item">
                            <a href="{{url('api/viewuser',$user->id)}}" class="btn btn-success"  onclick="return confirm('are you sure to View this user?')">View</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{url('api/edituser',$user->id)}}" class="btn btn-primary"  onclick="return confirm('are you sure to Edit this user?')">Edit</a>
                        </li>
