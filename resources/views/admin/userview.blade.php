    ...
    <div class="card ">
      ...
      <div class="table-responsive">
        <table class="table align-items-center ">
          <tbody>
            <a href="{{ url('api/usersadd') }}" class="btn btn-success">Add New</a>
            ...
            <tr>
              ...
              <td class="align-middle text-sm w-30">
                <div class="col text-center">
                  <h6 class="text-sm mb-0">{{$user->gender}}</h6>
                </div>
              </td>
                ...
                <div class="col text-center">
                    <ul class="list-inline m-0">
                        <li class="list-inline-item">
                            <a href="{{url('api/userdetails',$user->id)}}" class="btn btn-success"  onclick="return confirm('are you sure to View this user?')">View</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{url('api/useredit',$user->id)}}" class="btn btn-primary"  onclick="return confirm('are you sure to Edit this user?')">Edit</a>
                        </li>

                        <li class="list-inline-item">
                            <a href="{{url('api/deleteuser',$user->id)}}" class="btn btn-danger"  onclick="return confirm('are you sure to Delete this user?')">Delete</a>
                        </li>
                    </ul>
                </div>
              </td>
